...
class MusicPlayer {
    ...
    private setupEventListeners(): void {
        ...
        document.getElementById('btn-mover-inicio')?.addEventListener('click', () => this.moveCurrentToStart());
        document.getElementById('btn-mover-final')?.addEventListener('click', () => this.moveCurrentToEnd());
    ...
    private setupSidebar(): void {
        ...
        toggleSidebar?.addEventListener('click', () => {
            ...
            document.querySelector('.sidebar')?.classList.toggle('collapsed', this.isSidebarCollapsed);
            document.querySelector('.main-content')?.classList.toggle('sidebar-collapsed', this.isSidebarCollapsed);
        });
    }

    private setActiveMenuItem(selectedItem: Element): void {
        document.querySelectorAll('.menu-item').forEach(item => {
    ...
    private stopVinylAnimation(): void {
        const vinyl = document.querySelector('.vinyl');
    ...
    private moveCurrentToStart(): void {
    ...
    private renderPlaylist(): void {
        ...
        this.playlist.getList().forEach(song => {
            ...
            songElement.className = `song-item ${currentSong?.id === song.id ? 'active' : ''}`;
