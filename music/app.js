...
class MusicPlayer {
        ...
        const initialSongs = [
            {
                ...
                title: 'Midnight City',
                artist: 'M83',
                source: 'mp3/midnight-city.mp3',
                cover: 'img/covers/midnight-city.jpg'
            },
            {
                id: '2',
                title: 'Blinding Lights',
                artist: 'The Weeknd',
                source: 'mp3/blinding-lights.mp3',
                cover: 'img/covers/blinding-lights.jpg'
            },
            {
                id: '3',
                title: 'Levitating',
                artist: 'Dua Lipa',
                source: 'mp3/levitating.mp3',
                cover: 'img/covers/levitating.jpg'
            }
        ];
    ...
    setupEventListeners() {
        ...
        (_f = document.getElementById('btn-mover-inicio')) === null || _f === void 0 ? void 0 : _f.addEventListener('click', () => this.moveCurrentToStart());
        (_g = document.getElementById('btn-mover-final')) === null || _g === void 0 ? void 0 : _g.addEventListener('click', () => this.moveCurrentToEnd());
        // Carga de canciones
    ...
    setupSidebar() {
        ...
        toggleSidebar === null || toggleSidebar === void 0 ? void 0 : toggleSidebar.addEventListener('click', () => {
            ...
            (_a = document.querySelector('.sidebar')) === null || _a === void 0 ? void 0 : _a.classList.toggle('collapsed', this.isSidebarCollapsed);
            (_b = document.querySelector('.main-content')) === null || _b === void 0 ? void 0 : _b.classList.toggle('sidebar-collapsed', this.isSidebarCollapsed);
        });
    }
    ...
    processFiles(files) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.renderPlaylist();
            this.showNotification(`${files.length} canciones cargadas exitosamente!`);
        });
    }
    ...
    startVinylAnimation() {
        ...
        vinyl === null || vinyl === void 0 ? void 0 : vinyl.classList.add('playing');
    }
    stopVinylAnimation() {
        const vinyl = document.querySelector('.vinyl');
        vinyl === null || vinyl === void 0 ? void 0 : vinyl.classList.remove('playing');
    }
    playSong(id) {
        try {
    ...
    moveCurrentToStart() {
        if (this.playlist.moveCurrentToStart()) {
            ...
            if (currentSong) {
                this.highlightActiveSong(currentSong.id);
            }
        }
    }
    moveCurrentToEnd() {
    ...
    toggleShuffleMode() {
        ...
        if (shuffleIcon) {
            shuffleIcon.classList.toggle('active', this.isShuffle);
        }
    }
    toggleRepeatMode() {
        ...
        if (repeatIcon) {
            repeatIcon.classList.toggle('active', this.isRepeat);
        }
    }
    handleSongEnd() {
        if (!this.isRepeat) {
    ...
    renderPlaylist() {
        ...
        this.playlist.getList().forEach(song => {
            ...
            songElement.className = `song-item ${(currentSong === null || currentSong === void 0 ? void 0 : currentSong.id) === song.id ? 'active' : ''}`;
            ...
            songElement.innerHTML = `
                ...
                <div class="song-actions">
                    <button class="btn-remove" data-id="${song.id}">
